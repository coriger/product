...
@Entity
@Table(name = "zs_product")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "zs_product_sequence")
public class Product extends BaseEntity {
	...
	@Valid
	@ElementCollection
	@CollectionTable(name = "zs_product_product_image")
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "zx_product_specification")
	@OrderBy("order asc")
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "zx_product_specification_value")
	...
	@CollectionTable(name = "zs_product_member_price")
	 ...
	 */
	@ElementCollection(fetch = FetchType.LAZY)
	@CollectionTable(name = "zs_product_parameter_value")
